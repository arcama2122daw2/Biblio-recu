...
<body>
    ...
    <div>
        <a href="../../funcions/funcionsBibliotecaris.php"><input type="button" Value="<-- Enrere" /></a><br><br>
    </div>
    ...
    <div>
        <form action="veureBibliotecari.php" method="POST">
            Introdueix el codi del bibliotecari a Veure:
